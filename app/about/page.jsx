                ...
                <div className="hidden lg:block">
                    ...
                    <div className="grid grid-cols-12 gap-8 lg:gap-4 items-center min-h-[480px] sm:min-h-[560px]">
                        ...
                        <div className="col-span-6 space-y-6 lg:pr-2 z-10">
                            ...
                            <div className="pt-2">
                                <Link href="/academics" className="inline-flex group">
                        ...
                        <div className="col-span-6 relative flex items-center justify-start lg:justify-center min-h-[340px] sm:min-h-[420px]">
                            <div className="relative lg:ml-[-50px] xl:ml-[-90px] bg-gradient-to-br from-white/60 via-white/35 to-white/20 dark:from-[#0b1c14]/80 dark:via-[#08180f]/75 dark:to-[#040e08]/70 backdrop-blur-2xl p-6 sm:p-7 rounded-[2.2rem] border-[1.5px] border-white/95 dark:border-[#183a27] shadow-[inset_0_2px_4px_rgba(255,255,255,1),inset_0_-2px_4px_rgba(255,255,255,0.3),inset_2px_0_4px_rgba(255,255,255,0.8),0_25px_50px_-10px_rgba(0,30,15,0.25)] dark:shadow-[0_25px_50px_-10px_rgba(0,0,0,0.5)] w-52 sm:w-60 z-20 group transition-all duration-500 hover:-translate-y-2 hover:shadow-[inset_0_2px_4px_rgba(255,255,255,1),0_35px_70px_-10px_rgba(0,30,15,0.35)] cursor-pointer">
                                ...
                                <div className="w-12 h-12 rounded-full bg-gradient-to-b from-white/90 via-white/60 to-white/30 dark:from-[#132c1e] dark:to-[#0b1c14] backdrop-blur-2xl border-[1.5px] border-white dark:border-[#1e422c] shadow-[inset_0_2px_4px_rgba(255,255,255,1),inset_0_-2px_4px_rgba(0,0,0,0.1),0_10px_20px_rgba(0,25,12,0.18)] dark:shadow-[0_10px_20px_rgba(0,0,0,0.4)] flex items-center justify-center absolute -top-5 -right-5 text-[#122418] dark:text-[#a2d45e] z-30 transition-all duration-500 group-hover:scale-115 group-hover:rotate-12 group-hover:text-[#1a5e35] dark:group-hover:text-[#bbf07d] group-hover:from-white group-hover:to-[#e8f2e7] dark:group-hover:from-[#1b3e2a] dark:group-hover:to-[#10281b]">
                                    <Sprout size={20} strokeWidth={1.75} />
                                </div>
                                <p className="text-[10px] font-bold text-[#354839] dark:text-[#a2d45e] uppercase tracking-[0.2em] mb-1.5 relative z-10 drop-shadow-[0_1px_1px_rgba(255,255,255,0.8)] dark:drop-shadow-none group-hover:tracking-[0.25em] transition-all duration-300">
                                    Established in
                                </p>
                                <h3 className="text-4xl sm:text-5xl font-serif text-[#0f1d13] dark:text-white mb-3 tracking-tight font-normal relative z-10 drop-shadow-[0_1px_1px_rgba(255,255,255,0.6)] dark:drop-shadow-none group-hover:scale-105 origin-left transition-transform duration-300">
                                    2024
                                </h3>
                                ...
                                <div className="w-5 h-[1.5px] bg-[#1d3527]/70 dark:bg-[#a2d45e] rounded-full mt-2 relative z-10 group-hover:w-10 transition-all duration-300" />
                            </div>
                        </div>
                    ...
                    <div className="mt-24 sm:mt-32 lg:mt-36 grid grid-cols-12 gap-10 lg:gap-12 items-center relative z-20">
                        <div className="col-span-5 space-y-6">
                            ...
                            <div className="pt-2">
                                <Link href="/projects" className="inline-flex group">
                                    <button className="px-7 py-3.5 rounded-full bg-white/70 hover:bg-white dark:bg-[#0b1c14] dark:hover:bg-[#11261a] backdrop-blur-xl border-[1.5px] border-white dark:border-[#183a27] shadow-[inset_0_1.5px_2px_rgba(255,255,255,1),0_8px_20px_rgba(0,0,0,0.04)] text-[#162d1f] dark:text-[#a2d45e] text-[11px] font-bold uppercase tracking-wider flex items-center gap-3 transition-all duration-300 hover:scale-105 active:scale-95 hover:shadow-lg cursor-pointer">
                                        <span>Explore Research & Projects</span>
                                        <div className="w-5 h-5 rounded-full border border-slate-300 dark:border-[#1e422c] flex items-center justify-center group-hover:bg-[#1a5e35] group-hover:border-[#1a5e35] group-hover:text-white transition-all duration-300">
                        ...
                        <div className="col-span-7 grid grid-cols-2 gap-4">
                            <div className="col-span-2 relative h-52 sm:h-56 rounded-[2.2rem] overflow-hidden shadow-[inset_0_2px_4px_rgba(255,255,255,0.8),0_15px_35px_rgba(0,25,12,0.06)] dark:shadow-[0_15px_35px_rgba(0,0,0,0.4)] group border-[1.5px] border-white/90 dark:border-[#183a27] transition-all duration-500 hover:-translate-y-1.5 hover:shadow-xl cursor-pointer">
                                <img
                                    src="/about/about2.png"
                                    alt="Inspiring environments"
                                    className="absolute inset-0 w-full h-full object-cover group-hover:scale-108 transition-transform duration-700 ease-out"
                                />
                                <div className="absolute left-6 sm:left-8 bottom-6 flex items-center gap-3.5 bg-white/30 dark:bg-[#0b1c14]/85 backdrop-blur-2xl border-[1.5px] border-white/80 dark:border-[#183a27] shadow-[inset_0_1.5px_2px_rgba(255,255,255,0.9),0_10px_25px_rgba(0,0,0,0.2)] rounded-full p-2.5 pr-6 text-white transition-all duration-300 group-hover:bg-white/45 dark:group-hover:bg-[#122c1e] group-hover:shadow-lg">
                                    <div className="w-9 h-9 rounded-full bg-white/40 dark:bg-[#132c1e] backdrop-blur-md border border-white/80 dark:border-[#1e422c] flex items-center justify-center shrink-0 shadow-sm text-white dark:text-[#a2d45e] group-hover:scale-110 group-hover:bg-[#1a5e35] transition-all duration-300">
                                        <Building2 size={16} />
                                    </div>
                            ...
                            <div className="relative h-52 sm:h-56 rounded-[2.2rem] overflow-hidden shadow-[inset_0_2px_4px_rgba(255,255,255,0.8),0_15px_35px_rgba(0,25,12,0.06)] dark:shadow-[0_15px_35px_rgba(0,0,0,0.4)] group border-[1.5px] border-white/90 dark:border-[#183a27] transition-all duration-500 hover:-translate-y-1.5 hover:shadow-xl cursor-pointer">
                                ...
                                <div className="absolute inset-0 flex items-center justify-center p-6 text-center">
                                    <div className="flex flex-col items-center gap-3 bg-white/30 dark:bg-[#0b1c14]/85 backdrop-blur-2xl border-[1.5px] border-white/80 dark:border-[#183a27] shadow-[inset_0_1.5px_2px_rgba(255,255,255,0.9),0_10px_25px_rgba(0,0,0,0.2)] rounded-[1.8rem] p-5 w-full text-white transition-all duration-300 group-hover:bg-white/45 dark:group-hover:bg-[#122c1e] group-hover:shadow-lg">
                                        <div className="w-9 h-9 rounded-full bg-white/40 dark:bg-[#132c1e] backdrop-blur-md border border-white/80 dark:border-[#1e422c] flex items-center justify-center shrink-0 shadow-sm text-white dark:text-[#a2d45e] group-hover:scale-110 group-hover:bg-[#1a5e35] transition-all duration-300">
                                            <Users size={16} />
                                        </div>
                    ...
                    <div className="mt-24 sm:mt-32 lg:mt-36 relative z-20">
                        <div className="flex flex-col sm:flex-row justify-between sm:items-end gap-6 mb-10">
                            ...
                            <Link href="/projects" className="shrink-0 group">
                                <button className="px-6 py-3 rounded-full bg-white/80 hover:bg-white dark:bg-[#0b1c14] dark:hover:bg-[#11261a] backdrop-blur-xl border border-white/90 dark:border-[#183a27] shadow-[inset_0_1.5px_2px_rgba(255,255,255,1),0_8px_20px_rgba(0,0,0,0.03)] text-[#162d1f] dark:text-[#a2d45e] text-[11px] font-bold uppercase tracking-wider flex items-center gap-3 transition-all duration-300 hover:scale-105 active:scale-95 hover:shadow-md cursor-pointer">
                    ...
                    <div className="mt-24 sm:mt-32 lg:mt-36 relative z-20">
                        <div className="grid grid-cols-12 gap-4">
                            <div className="col-span-4 rounded-[2rem] bg-gradient-to-br from-white/70 via-white/45 to-white/25 dark:from-[#0b1c14]/90 dark:via-[#08180f]/85 dark:to-[#040e08]/80 backdrop-blur-2xl border-[1.5px] border-white/95 dark:border-[#183a27] shadow-[inset_0_2px_4px_rgba(255,255,255,1),0_20px_45px_rgba(0,25,12,0.05)] dark:shadow-[0_20px_45px_rgba(0,0,0,0.4)] p-7 sm:p-8 flex flex-col justify-between relative overflow-hidden min-h-[460px] group transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl cursor-pointer">
                                <div className="relative z-10">
                                    <div className="flex items-center gap-1.5 mb-5">
                                        <Leaf size={13} className="text-[#2d5a3c] dark:text-[#a2d45e] fill-[#2d5a3c] dark:fill-[#a2d45e] group-hover:rotate-12 transition-transform duration-300" />
                                        <span className="text-[10.5px] font-bold tracking-[0.18em] text-[#3d5042] dark:text-[#a2d45e] uppercase">
                                            KEY INITIATIVES
                                        </span>
                                    </div>
                                    <h3 className="text-3xl font-serif font-normal text-[#122016] dark:text-white tracking-tight mb-3 drop-shadow-[0_1px_1px_rgba(255,255,255,0.8)] dark:drop-shadow-none group-hover:text-[#1a5e35] dark:group-hover:text-[#a2d45e] transition-colors duration-300">
                                        STEM Learning Lab
                                    </h3>
                                ...
                                <div className="w-9 h-9 rounded-full bg-white dark:bg-[#11261a] border border-white/90 dark:border-[#1e422c] shadow-[0_4px_12px_rgba(0,0,0,0.08)] flex items-center justify-center text-[#14261a] dark:text-[#a2d45e] group-hover:scale-115 group-hover:bg-[#1a5e35] group-hover:text-white transition-all duration-300 cursor-pointer z-10 mt-6 shrink-0">
                                    <ArrowRight size={13} className="group-hover:translate-x-0.5 transition-transform duration-300" />
                                </div>

                                <div className="absolute -bottom-2 -right-4 w-[78%] max-w-[250px] pointer-events-none group-hover:scale-108 group-hover:-translate-y-1 transition-transform duration-700 ease-out z-0 opacity-90 dark:opacity-75">
                                    <img
                                        src="/about/a1.png"
                            ...
                            <div className="col-span-8 grid grid-cols-2 gap-4">
                                {[
                                    ...
                                    <div
                                        key={i}
                                        className="rounded-[2rem] overflow-hidden relative min-h-[220px] sm:min-h-[230px] border-[1.5px] border-white/95 dark:border-[#183a27] shadow-[inset_0_2px_4px_rgba(255,255,255,0.9),0_15px_35px_rgba(0,25,12,0.05)] dark:shadow-[0_15px_35px_rgba(0,0,0,0.4)] bg-white/50 dark:bg-[#0b1c14]/90 backdrop-blur-xl flex flex-col justify-between p-7 sm:p-8 group transition-all duration-500 hover:-translate-y-1.5 hover:shadow-xl cursor-pointer"
                                    >
                                        <img
                                            src={item.img}
                                            alt={item.title}
                                            className="absolute inset-0 w-full h-full object-cover group-hover:scale-108 transition-transform duration-700 ease-out opacity-90 dark:opacity-60"
                                        />
                                        <div className="absolute inset-0 bg-gradient-to-r from-[#f0f3eb]/95 via-[#f0f3eb]/80 to-transparent dark:from-[#08180f]/95 dark:via-[#08180f]/75 dark:to-transparent" />

                                        <div className="relative z-10">
                                            <h4 className="text-[17px] font-serif font-semibold text-[#122016] dark:text-white mb-2 leading-snug drop-shadow-[0_1px_1px_rgba(255,255,255,0.8)] dark:drop-shadow-none group-hover:text-[#1a5e35] dark:group-hover:text-[#a2d45e] transition-colors duration-300">
                                                {item.title}
                                            </h4>
                                        ...
                                        <div className="relative z-10 w-9 h-9 rounded-full bg-white dark:bg-[#11261a] border border-white/90 dark:border-[#1e422c] shadow-[0_4px_12px_rgba(0,0,0,0.08)] flex items-center justify-center text-[#14261a] dark:text-[#a2d45e] group-hover:scale-115 group-hover:bg-[#1a5e35] group-hover:text-white transition-all duration-300 cursor-pointer shrink-0 mt-4">
                                            <ArrowRight size={13} className="group-hover:translate-x-0.5 transition-transform duration-300" />
                                        </div>
                                    </div>
                                ))}
                    ...
                    <div className="mt-16 sm:mt-24 mb-12 rounded-[2.4rem] bg-gradient-to-b from-white/60 via-white/40 to-white/25 dark:from-[#0b1c14]/90 dark:via-[#08180f]/85 dark:to-[#040e08]/80 backdrop-blur-3xl border-[1.5px] border-white/95 dark:border-[#183a27] shadow-[inset_0_2px_4px_rgba(255,255,255,1),0_20px_45px_rgba(0,25,12,0.05)] dark:shadow-[0_20px_45px_rgba(0,0,0,0.4)] p-5 sm:p-6 grid grid-cols-12 gap-6 items-center relative z-20 transition-all duration-500 hover:shadow-xl">
                        ...
                        <div className="col-span-3 p-6 rounded-[2rem] bg-gradient-to-b from-white/80 via-white/55 to-white/35 dark:from-[#11261a]/90 dark:via-[#0c1f15]/80 dark:to-[#08160f]/80 backdrop-blur-2xl border-[1.5px] border-white/95 dark:border-[#183a27] shadow-[inset_0_2px_4px_rgba(255,255,255,1),0_12px_28px_rgba(0,25,12,0.05)] dark:shadow-[0_12px_28px_rgba(0,0,0,0.3)] flex flex-col items-center justify-center text-center transition-all duration-500 hover:-translate-y-1.5 hover:shadow-lg min-h-[170px] group cursor-pointer">
                            <div className="w-13 h-13 rounded-full bg-gradient-to-b from-white/95 via-white/60 to-white/30 dark:from-[#183d28] dark:to-[#112c1d] backdrop-blur-xl border border-white dark:border-[#1e422c] shadow-[inset_0_2px_3px_rgba(255,255,255,1),0_6px_14px_rgba(0,20,10,0.08)] flex items-center justify-center text-[#162d1f] dark:text-[#a2d45e] mb-3.5 group-hover:scale-115 group-hover:rotate-6 group-hover:text-[#1a5e35] dark:group-hover:text-[#bbf07d] group-hover:border-[#1a5e35]/40 dark:group-hover:border-[#a2d45e]/50 group-hover:from-white group-hover:to-[#e8f2e7] dark:group-hover:from-[#1b3e2a] dark:group-hover:to-[#10281b] transition-all duration-300">
                                <HeartHandshake size={22} strokeWidth={1.5} />
                            </div>
                            <p className="text-[12px] font-semibold text-[#182b1d] dark:text-white leading-relaxed drop-shadow-[0_1px_1px_rgba(255,255,255,0.8)] dark:drop-shadow-none group-hover:text-[#1a5e35] dark:group-hover:text-[#a2d45e] transition-colors duration-300">
                    ...
                    <div className="mt-8 mb-4 rounded-[2.4rem] bg-gradient-to-b from-white/65 via-white/45 to-white/25 dark:from-[#0b1c14]/90 dark:via-[#08180f]/85 dark:to-[#040e08]/80 backdrop-blur-3xl border-[1.5px] border-white/95 dark:border-[#183a27] shadow-[inset_0_2px_4px_rgba(255,255,255,1),0_20px_45px_rgba(0,25,12,0.05)] dark:shadow-[0_20px_45px_rgba(0,0,0,0.4)] p-8 sm:p-10 relative z-20 transition-all duration-500 hover:shadow-xl">
                        <div className="grid grid-cols-12 gap-8 items-center">
                            ...
                            <div className="col-span-5 space-y-3 p-5 sm:p-6 rounded-[1.8rem] bg-white/60 dark:bg-[#11261a]/70 backdrop-blur-xl border border-white/90 dark:border-[#1e422c] shadow-sm hover:shadow-md hover:border-[#1a5e35]/30 transition-all duration-300">
                                ...
                                <div className="flex items-center gap-3 text-xs text-[#354639] dark:text-slate-300 pt-1">
                                    ...
                                    <a href="mailto:lenseedu24@gmail.com" className="text-[#1a3825] dark:text-[#a2d45e] font-semibold hover:underline hover:text-[#2d5a3c] transition-colors">
                ...
                <div className="block lg:hidden pb-12">
                    ...
                    <div className="pt-3 pb-2 relative">
                        <div className="grid grid-cols-12 gap-2.5 items-start">
                            ...
                            <div className="col-span-5 flex justify-end items-start pt-1 relative">
                                <div className="relative bg-white/90 dark:bg-[#0b1c14]/85 backdrop-blur-2xl p-3.5 sm:p-4 rounded-2xl border border-[#e8efe9] dark:border-[#183a27] shadow-[0_8px_25px_rgba(0,0,0,0.05)] w-full max-w-[165px] z-20 group transition-all duration-300 hover:-translate-y-1 hover:shadow-lg cursor-pointer">
                                    {/* Signature Mint Circle Badge */}
                                    <div className="w-8 h-8 rounded-full bg-[#eef4ef] dark:bg-[#11261a] border border-[#d6e2d8] dark:border-[#1e422c] shadow-sm flex items-center justify-center absolute -top-2.5 -right-2.5 text-[#174b2b] dark:text-[#a2d45e] z-30 group-hover:scale-115 group-hover:rotate-12 group-hover:bg-[#dce9de] dark:group-hover:bg-[#183d28] group-hover:text-[#1a5e35] dark:group-hover:text-[#bbf07d] transition-all duration-300">
                                        <Sprout size={16} strokeWidth={2} />
                                    </div>

                                    <p className="text-[9px] font-bold text-[#1b432a] dark:text-[#a2d45e] uppercase tracking-wider mb-0.5 relative z-10 group-hover:tracking-widest transition-all duration-300">
                                        Established in
                                    </p>

                                    <h3 className="text-3xl font-serif text-[#112318] dark:text-white mb-0.5 tracking-tight font-bold relative z-10 group-hover:scale-105 origin-left transition-transform duration-300">
                                        2024
                                    </h3>
                                    ...
                                    <div className="w-5 h-[2px] bg-[#1a5e35] dark:bg-[#a2d45e] rounded-full mt-1.5 relative z-10 group-hover:w-8 transition-all duration-300" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mt-8 grid grid-cols-12 gap-3 items-center relative z-20">
                        ...
                        <div className="col-span-5 space-y-2 pr-0.5">
                            {/* Homepage-style Pill Badge */}
                            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white dark:bg-[#0c1f15] border border-[#e8efe9] dark:border-[#1e422c] shadow-sm hover:scale-105 transition-transform duration-300">
                            ...
                            <div className="pt-1">
                                <Link href="/projects" className="inline-flex group">
                                    <button className="px-3.5 py-1.5 sm:px-4 sm:py-2 rounded-full bg-white hover:bg-[#f8faf8] dark:bg-[#0c1f15] dark:hover:bg-[#122c1e] border border-[#d6e0d8] dark:border-[#1e422c] shadow-sm text-[#0a311b] dark:text-[#a2d45e] text-[9.5px] sm:text-xs font-semibold tracking-wide flex items-center gap-1.5 transition-all duration-300 hover:scale-105 active:scale-95 hover:shadow-md">
                                        <span>Explore Research & Projects</span>
                        ...
                        <div className="col-span-7 grid grid-cols-2 gap-2">
                            {/* Top Wide Glass Card */}
                            <div className="col-span-2 relative h-20 sm:h-26 rounded-xl overflow-hidden shadow-sm border border-[#e8efe9] dark:border-[#183a27] group cursor-pointer hover:-translate-y-0.5 hover:shadow-md transition-all duration-300">
                                <img
                                    src="/about/about2.png"
                                    alt="Inspiring environments"
                                    className="absolute inset-0 w-full h-full object-cover group-hover:scale-108 transition-transform duration-700 ease-out"
                                />
                                <div className="absolute left-2 bottom-1.5 flex items-center gap-1.5 bg-[#082012]/80 dark:bg-black/70 backdrop-blur-md border border-white/20 rounded-full px-2.5 py-1 text-white group-hover:bg-[#082012]/95 transition-all duration-300">
                                    <div className="w-3.5 h-3.5 rounded-full bg-white/25 flex items-center justify-center shrink-0 group-hover:scale-110 group-hover:bg-[#1a5e35] transition-all duration-300">
                                        <ArrowRight size={8} />
                                    </div>
                            ...
                            <div className="relative h-20 sm:h-26 rounded-xl overflow-hidden shadow-sm border border-[#e8efe9] dark:border-[#183a27] group cursor-pointer hover:-translate-y-0.5 hover:shadow-md transition-all duration-300">
                                <img
                                    src="/about/about3.png"
                                    alt="Collaborating"
                                    className="absolute inset-0 w-full h-full object-cover group-hover:scale-108 transition-transform duration-700 ease-out"
                                />
                                <div className="absolute left-1.5 bottom-1.5 right-1.5 flex items-center gap-1 bg-[#082012]/80 dark:bg-black/70 backdrop-blur-md border border-white/20 rounded-full px-2 py-1 text-white group-hover:bg-[#082012]/95 transition-all duration-300">
                                    <div className="w-3.5 h-3.5 rounded-full bg-white/25 flex items-center justify-center shrink-0 group-hover:scale-110 group-hover:bg-[#1a5e35] transition-all duration-300">
                                        <ArrowRight size={7} />
                                    </div>
                            ...
                            <div className="relative h-20 sm:h-26 rounded-xl bg-white/90 dark:bg-[#0b1c14]/90 backdrop-blur-2xl border border-[#e8efe9] dark:border-[#183a27] shadow-sm p-2 flex flex-col justify-center items-center text-center group cursor-pointer hover:-translate-y-0.5 hover:shadow-md transition-all duration-300">
                                <div className="w-7 h-7 rounded-full bg-[#eef4ef] dark:bg-[#11261a] border border-[#dce8de] dark:border-[#1e422c] shadow-sm flex items-center justify-center text-[#174b2b] dark:text-[#a2d45e] mb-1 group-hover:scale-115 group-hover:rotate-12 group-hover:bg-[#dce9de] dark:group-hover:bg-[#183d28] group-hover:text-[#1a5e35] dark:group-hover:text-[#bbf07d] transition-all duration-300">
                                    <FlaskConical size={13} strokeWidth={1.6} />
                                </div>
                                <p className="text-[#112318] dark:text-white text-[9px] sm:text-[10.5px] font-medium leading-snug group-hover:text-[#1a5e35] dark:group-hover:text-[#a2d45e] transition-colors duration-300">
                                    A dedicated STEM Learning Lab for hands-on, experiential learning.
                                </p>
                            </div>
                    ...
                    <div className="mt-8 relative z-20">
                        <div className="flex justify-between items-end mb-3">
                            ...
                            <Link href="/projects" className="shrink-0 group">
                                <button className="px-3 py-1.5 rounded-full bg-white hover:bg-[#f8faf8] dark:bg-[#0c1f15] dark:hover:bg-[#122c1e] border border-[#d6e0d8] dark:border-[#1e422c] text-[#0a311b] dark:text-[#a2d45e] text-[9px] sm:text-[10.5px] font-semibold tracking-wide flex items-center gap-1 shadow-sm transition-all duration-300 hover:scale-105 active:scale-95">
                                    <span>View All Objectives</span>
                        ...
                        <div className="grid grid-cols-3 gap-2 mb-2">
                            {[
                                ...
                                <div
                                    key={i}
                                    className="bg-white/90 dark:bg-[#0b1c14]/85 backdrop-blur-2xl border border-[#e8efe9] dark:border-[#183a27] rounded-2xl p-2.5 sm:p-3 flex flex-col justify-between shadow-[0_4px_20px_rgba(0,0,0,0.03)] group cursor-pointer hover:-translate-y-1 hover:shadow-md hover:border-[#1a5e35]/30 transition-all duration-300 active:scale-95"
                                >
                                    <div className="w-8 h-8 rounded-full bg-[#eef4ef] dark:bg-[#11261a] border border-[#dce8de] dark:border-[#1e422c] shadow-sm flex items-center justify-center text-[#174b2b] dark:text-[#a2d45e] mb-2 shrink-0 group-hover:scale-110 group-hover:rotate-6 group-hover:bg-[#dce9de] dark:group-hover:bg-[#183d28] group-hover:text-[#1a5e35] dark:group-hover:text-[#bbf07d] transition-all duration-300">
                                        <obj.icon size={15} strokeWidth={1.6} />
                                    </div>
                                    <div>
                                        <div className="text-[9px] sm:text-[10px] font-bold text-[#1a5e35] dark:text-[#a2d45e] uppercase tracking-wider mb-0.5 group-hover:tracking-widest transition-all duration-300">
                                            {obj.num}
                                        </div>
                                        <h4 className="text-[10.5px] sm:text-xs font-serif font-bold text-[#112318] dark:text-white mb-1 leading-snug whitespace-pre-line group-hover:text-[#1a5e35] dark:group-hover:text-[#a2d45e] transition-colors duration-300">
                                            {obj.title}
                                        </h4>
                    ...
                    <div className="mt-8 relative z-20">
                        ...
                        <div className="rounded-2xl bg-white/90 dark:bg-[#0b1c14]/85 backdrop-blur-2xl border border-[#e8efe9] dark:border-[#183a27] shadow-[0_8px_30px_rgba(0,0,0,0.04)] p-4 relative overflow-hidden mb-2.5 group cursor-pointer hover:-translate-y-1 hover:shadow-lg transition-all duration-300">
                            <div className="relative z-10 max-w-[58%]">
                                <div className="flex items-center gap-1.5 mb-1">
                                    <Leaf size={11} className="fill-[#1b432a] text-[#1b432a] dark:fill-[#a2d45e] dark:text-[#a2d45e] group-hover:rotate-12 transition-transform duration-300" />
                                    <span className="text-[9.5px] font-bold tracking-wider text-[#1b432a] dark:text-[#a2d45e] uppercase">
                                        KEY INITIATIVES
                                    </span>
                                </div>
                                <h3 className="text-base sm:text-xl font-serif font-normal text-[#112318] dark:text-white tracking-tight mb-1 group-hover:text-[#1a5e35] dark:group-hover:text-[#a2d45e] transition-colors duration-300">
                                    STEM Learning Lab
                                </h3>
                                ...
                                <Link href="/projects" className="inline-flex group/btn">
                                    <button className="px-3 py-1.5 rounded-full bg-white hover:bg-[#f8faf8] border border-[#d6e0d8] dark:bg-[#0c1f15] dark:border-[#1e422c] shadow-sm text-[#0a311b] dark:text-[#a2d45e] text-[9px] sm:text-xs font-semibold tracking-wide flex items-center gap-1.5 transition-all duration-300 hover:scale-105 active:scale-95">
                                        <span>Explore Research & Projects</span>
                                        <ArrowRight size={8} className="group-hover/btn:translate-x-0.5 transition-transform duration-300" />
                                    </button>
                                </Link>
                            </div>
                            ...
                            <div className="absolute top-2.5 bottom-2.5 right-2.5 w-[38%] rounded-xl overflow-hidden shadow-sm border border-[#e8efe9]">
                                <img
                                    ...
                                    className="w-full h-full object-cover group-hover:scale-108 transition-transform duration-700 ease-out"
                                />
                                <div className="absolute right-2 bottom-2 w-5 h-5 rounded-full bg-[#083a20] dark:bg-[#124225] shadow-sm flex items-center justify-center text-white dark:text-[#a2d45e] group-hover:scale-110 group-hover:bg-[#1a5e35] transition-all duration-300">
                                    <ArrowRight size={9} />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            {[
                                ...
                                <div
                                    key={i}
                                    className="rounded-2xl overflow-hidden relative min-h-[95px] sm:min-h-[110px] border border-[#e8efe9] dark:border-[#183a27] shadow-sm bg-white/90 dark:bg-[#0b1c14]/85 backdrop-blur-xl flex flex-col justify-between p-3 group cursor-pointer hover:-translate-y-1 hover:shadow-md transition-all duration-300 active:scale-95"
                                >
                                    <img
                                        src={item.img}
                                        alt={item.title}
                                        className="absolute inset-0 w-full h-full object-cover opacity-85 dark:opacity-60 group-hover:scale-108 transition-transform duration-700 ease-out"
                                    />
                                    ...
                                    <div className="relative z-10">
                                        <h4 className="text-[11px] sm:text-xs font-serif font-bold text-[#112318] dark:text-white mb-0.5 leading-snug group-hover:text-[#1a5e35] dark:group-hover:text-[#a2d45e] transition-colors duration-300">
                                            {item.title}
                                        </h4>
                                    ...
                                    <div className="relative z-10 w-5 h-5 rounded-full bg-[#083a20] dark:bg-[#124225] border border-white/20 shadow-sm flex items-center justify-center text-white dark:text-[#a2d45e] shrink-0 mt-1 self-end group-hover:scale-110 group-hover:bg-[#1a5e35] transition-all duration-300">
                                        <ArrowRight size={8} className="group-hover:translate-x-0.5 transition-transform duration-300" />
                                    </div>
                                </div>
                            ))}
                    ...
                    <div className="mt-8 rounded-2xl bg-white/90 dark:bg-[#0b1c14]/85 backdrop-blur-3xl border border-[#e8efe9] dark:border-[#183a27] shadow-[0_8px_30px_rgba(0,0,0,0.04)] p-3.5 grid grid-cols-12 gap-2.5 items-center relative z-20 group hover:shadow-md transition-shadow duration-300">
                        {/* Left image */}
                        ...
                        {/* Right Glass Card */}
                        <div className="col-span-3 p-2 rounded-xl bg-[#eef5f0] dark:bg-[#11261a] border border-[#d6e2d8] dark:border-[#1e422c] shadow-sm flex flex-col items-center justify-center text-center min-h-[75px] hover:-translate-y-0.5 hover:shadow-sm transition-all duration-300 cursor-pointer">
                            <div className="w-7 h-7 rounded-full bg-white dark:bg-[#0b1c14] border border-[#dce8de] shadow-sm flex items-center justify-center text-[#174b2b] dark:text-[#a2d45e] mb-1 group-hover:scale-115 group-hover:rotate-6 group-hover:bg-[#dce9de] dark:group-hover:bg-[#183d28] group-hover:text-[#1a5e35] dark:group-hover:text-[#bbf07d] transition-all duration-300">
                    ...
                    <div className="mt-8 rounded-2xl bg-white/90 dark:bg-[#0b1c14]/85 backdrop-blur-3xl border border-[#e8efe9] dark:border-[#183a27] shadow-[0_8px_30px_rgba(0,0,0,0.04)] p-3.5 grid grid-cols-12 gap-2 items-center relative z-20 hover:shadow-md transition-shadow duration-300">
                        ...
                        <div className="col-span-3 flex justify-center">
                            <div className="w-18 h-18 sm:w-22 sm:h-22 rounded-xl overflow-hidden shadow-sm border border-[#e8efe9] group cursor-pointer">
                                <img src="/about/a1.png" className="w-full h-full object-cover group-hover:scale-108 transition-transform duration-500 ease-out" alt="Director" />
                            </div>
                        </div>

                        {/* Right: University Contact */}
                        <div className="col-span-4 space-y-1.5 p-2 sm:p-2.5 rounded-xl bg-[#eef5f0]/80 dark:bg-[#11261a]/80 backdrop-blur-xl border border-[#d6e2d8] dark:border-[#1e422c] shadow-sm hover:shadow-md transition-shadow duration-300">
                    ...
                    <div className="mt-8 rounded-2xl bg-[#083a20] dark:bg-[#0b2416] p-4 flex items-center justify-between shadow-lg relative z-20 hover:shadow-xl transition-shadow duration-300">
